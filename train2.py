...
train_dataset = FaceAlignmentDataset('training_images_full.npz', train=True, transform=Compose([Downscale(scale_down), RandomRotate(30), ToTensor()]), length=4)
#test_dataset = FaceAlignmentDataset('training_images_full.npz', train=False, transform=Compose([Downscale(scale_down), RandomRotate(30), ToTensor()]), length=4)
...
for epoch in range(epochs):
    for batch_i, batch in enumerate(train_loader):
        ...
        if batch_i % 100 == 99:  # every 100 mini-batches...
